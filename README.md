...
📄 Dokumen Laporan Akhir: Baca Laporan (PDF)
🎥 Video Demonstrasi & Penjelasan: Tonton di YouTube
...
Membaca dan mem-parsing file dataset.

Mengakumulasikan frekuensi kata dari seluruh dokumen.

Mengurutkan kata dari frekuensi terbesar ke terkecil (descending) menggunakan tiga algoritma sorting berbeda.

Mencetak daftar Top-K kata beserta frekuensinya ke layar monitor.

Menyimpan keseluruhan hasil pengurutan beserta kalkulasi waktu eksekusi (ms) ke dalam sebuah file teks eksternal.
...
Lakukan kompilasi menggunakan make:
...
Saat program berjalan, masukkan path dari file dataset docword (pastikan Anda sudah mengunduh dataset-nya). Contoh:
...
UCI Machine Learning Repository (Bag of Words Dataset): Link Dataset